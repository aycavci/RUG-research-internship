...
if True:
    ...
    ydata = data["Time(log10)"]
    ax.set_ylabel('Time(log10)')
...
if False:
    ...
    for label in labels:
        ...
        ax.scatter3D(data_filtered["MoRF"], data_filtered["Smoothness"], data_filtered["Time(log10)"], color=(.5, .5, .5),alpha=.5);
...
labels = ["MoRF","Smoothness","Time(log10)"]
