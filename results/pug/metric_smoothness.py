...
pug_vanilla = cv2.imread("pug_vanilla.png", cv2.IMREAD_GRAYSCALE)
print("pug_vanilla: " + str(metric_smoothness(pug_vanilla)))

pug_smoothgrad = cv2.imread("pug_smoothgrad.png", cv2.IMREAD_GRAYSCALE)
print("pug_smoothgrad: " + str(metric_smoothness(pug_smoothgrad)))

pug_xrai = cv2.imread("pug_xrai.png", cv2.IMREAD_COLOR)
print("pug_xrai: " + str(metric_smoothness(pug_xrai)))

pug_gradcam = cv2.imread("pug_gradcam.png", cv2.IMREAD_GRAYSCALE)
print("pug_gradcam: " + str(metric_smoothness(pug_gradcam)))

pug_blurIG = cv2.imread("pug_blurIG.png", cv2.IMREAD_GRAYSCALE)
print("pug_blurIG: " + str(metric_smoothness(pug_blurIG)))

pug_gradcam_smoothed = cv2.imread("pug_gradcam_smoothed.png", cv2.IMREAD_GRAYSCALE)
print("pug_gradcam_smoothed: " + str(metric_smoothness(pug_gradcam_smoothed)))

pug_blurIG_smoothed = cv2.imread("pug_blurIG_smoothed.png", cv2.IMREAD_GRAYSCALE)
